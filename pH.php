                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="turbidity.php">
                                <div class="sb-nav-link-icon"><si class="fas fa-table"></i></div>
                                Turbidity Datatable
                            </a>
                        </div>
                    </div>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">pH Data</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                            <li class="breadcrumb-item active">pH</li>
                            <li class="breadcrumb-item"><a href="turbidity.php">Turbidity</a></li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <?php
                                            ...
                                            $query = "SELECT pH, date_time FROM data";
